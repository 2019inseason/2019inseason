$(function () {
    ...
    $('._island_intro__btn').click(function () {
        ...
        var animData = {
            ...
            loop: true,
            autoplay: true,
            path: 'img/json/720/' + animArray[animIndex]
        };
        ...
        anim.addEventListener('DOMLoaded', function () { 
            ...
            switch(hoverIndex){
                ...
                break
                case 12:
                    $('#cabbage').append(makeImg(48,-1.3,-1.3,'cabbage'));
                    $('#botsai').append(makeImg(76,-2.2,-1.6,'botsai'));
                    $('#broccoli').append(makeImg(68,-1.2,-1.2,'broccoli'));
                    $('#uto').append(makeImg(139,2.2,-1.7,'uto'));
                    $('#tonghau').append(makeImg(58.5,-2,-1.7,'tonghau'));
                    $('#baitsai').append(makeImg(59.5,-1.8,-1.8,'baitsai'));
                    $('#pea').append(makeImg(94,-1.5,-1.6,'pea'));
                    $('#orange').append(makeImg(111.5,-1.3,-1,'orange'));
                    $('#strawberry').append(makeImg(54,-1.7,-1.5,'strawberry'));
                    $('#ponkan').append(makeImg(109,-1.5,-1.5,'ponkan'));
                    $('#grape').append(makeImg(96,-1.3,-1.4,'grape'));
                    $('#shizi').append(makeImg(99,-1.2,-1.4,'shizi'));
                    $('#whitelobo').append(makeImg(85,2.4,-1.5,'whitelobo'));
                break
            }
